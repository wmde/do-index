# Django settings for do-index project.
import os
...
DATABASE_NAME = 'walterpsql1'             # Or path to database file if using sqlite3.
DATABASE_USER = 'walterpsql1'             # Not used with sqlite3.
DATABASE_PASSWORD = '4042b378'         # Not used with sqlite3.
